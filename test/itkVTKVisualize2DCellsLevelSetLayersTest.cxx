...
int itkVTKVisualize2DCellsLevelSetLayersTest( int argc, char* argv[] )
{
  ...
  if( levelSetRepresentation.compare( "Whitaker" ) == 0 )
    {
    using LevelSetType = itk::WhitakerSparseLevelSetImage< double, 2 >;
    try
      {
    ...
    {
    using LevelSetType = itk::ShiSparseLevelSetImage< 2 >;
    try
      {
      visualizeLevelSet< InputImageType, LevelSetType >( input,
                                                         numberOfIterations,
    ...
    {
    using LevelSetType = itk::MalcolmSparseLevelSetImage< 2 >;
    try
      {
      visualizeLevelSet< InputImageType, LevelSetType >( input,
                                                         numberOfIterations,
